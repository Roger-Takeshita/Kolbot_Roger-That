                    ...
                    if (itemsArray[i] !== undefined) {
                        switch (itemsArray[i]) {
                            ...
                            case "shields":      // Shields
                                itemCodes = [328, 329, 330, 331, 332, 333, 350, 351, 374, 375, 376, 377, 378, 379, 396, 397, 410, 411, 412, 444, 445, 446, 447, 448, 449, 466, 467, 480, 481, 482, 486, 487, 498, 499, 500, 501, 502, 506, 507];
                                for (let j = 0; j < itemCodes.length; j++) {
                                    dropObj[itemCodes[j]] = {
                                        qty: qtyArray ? qtyArray[i] : 0,
                                        name: "shield"
