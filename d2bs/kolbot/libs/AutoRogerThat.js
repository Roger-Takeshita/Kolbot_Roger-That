                    ...
                    if (itemsArray[i] !== undefined) {
                        switch (itemsArray[i]) {
                            ...
                            case "shields":      // Shields
                                itemCodes = [328, 329, 330, 331, 332, 333, 350, 351, 374, 375, 376, 377, 378, 379, 396, 397, 410, 411, 412, 413, 414, 444, 445, 446, 447, 448, 449, 466, 467, 480, 481, 482, 486, 487, 498, 499, 500, 501, 502, 506, 507];
                                for (let j = 0; j < itemCodes.length; j++) {
                                    dropObj[itemCodes[j]] = {
                                        qty: qtyArray ? qtyArray[i] : 0,
                                        name: "shield"
                            ...
                            case "armor":
                            case "armors":       // Armors
                                itemCodes = [313, 314, 315, 316, 317, 318, 319, 320, 321, 322, 323, 324, 325, 326, 327, 334, 359, 360, 361, 362, 363, 364, 365, 366, 367, 368, 369, 370, 371, 372, 373, 429, 430, 431, 432, 433, 434, 435, 436, 437, 438, 439, 440, 441, 442, 443];
                                for (let j = 0; j < itemCodes.length; j++) {
                                    dropObj[itemCodes[j]] = {
                                        qty: qtyArray ? qtyArray[i] : 0,
                                        name: "armor"
