...
var AutoBuildTemplate={
	...
	1: 	{
			Update: function(){
				Config.PickitFiles.push("AutoLevel/Pickit/LateGame.nip");
				Config.PickitFiles.push("AutoLevel/Pickit/MidGame.nip");
				Config.PickitFiles.push("AutoLevel/Pickit/EarlyGame.nip");
				Config.PickitFiles.push("AutoLevel/Pickit/LightningRunes.nip");
				Config.PickitFiles.push("AutoLevel/AutoEquip/Lightning.xpac.nip");
				Config.PickitFiles.push("AutoLevel/AutoEquip/PreMerc.xpac.nip");
				Config.PickitFiles.push("AutoLevel/AutoEquip/Merc.xpac.nip");
	...
	2: 	{
			...
			Update: function(){
				...
				Config.AttackSkill=[38,38,38,38,38,0,0];
			}
		},
	...
	6: 	{
			...
			StatPoints: [0,1,1,3,3],
			Update: function(){
				Config.AttackSkill=[38,36,36,38,38,0,0];
			}
		},
	...
	25: 	{
			SkillPoints: [49],//Energy Shield
			StatPoints: [0,1,1,3,3],
			Update: function(){
				Config.PickitFiles.splice(Config.PickitFiles.indexOf("AutoLevel/AutoEquip/PreMerc.xpac.nip"),1);
			}	
		},
	...
	40: 	{
			...
			StatPoints: [0,1,1,3,3],
			Update: function(){
				Config.PickitFiles.splice(Config.PickitFiles.indexOf("AutoLevel/Pickit/EarlyGame.nip"),1);
			}
		},
	...
	70: 	{
			...
			StatPoints: [0,1,1,3,3],
			Update: function(){
				Config.PickitFiles.splice(Config.PickitFiles.indexOf("AutoLevel/Pickit/MidGame.nip"),1);
				//Eth Merc Weapon
