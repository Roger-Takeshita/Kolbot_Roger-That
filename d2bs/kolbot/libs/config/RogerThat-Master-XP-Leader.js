...
function LoadConfig() {
   ...
   //! SCRIPTS -------------------------------------------------------------------------
      ...
      Scripts.Baal = true;
         Config.Baal.HotTPMessage = "hot";                // Set msg to "hot" so AutoBaal can understand the commands
         Config.Baal.SafeTPMessage = "safe";              // Set msg to "safe" or "come" so AutoBaal can understand the commands
         Config.Baal.BaalMessage = "baal";                // Set msg to "baal" so AutoBaal can understand the commands
